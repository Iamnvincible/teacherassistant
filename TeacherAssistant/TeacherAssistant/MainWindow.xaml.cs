            ...
            else
            {
                ...
                for (int i = 0; i < disurls.Count; i++)
                {
                    ...
                    if (disurls[i].Substring(20).StartsWith("S"))
                    {
                        ...
                        { 
                            string insert = String.Format(itempatten+ "('{0}','{1}','{2}','{3}','{4}','{5}','{6}','{7}')", stu[trans].Num, stu[trans].Subject, stu[trans].StudentNum, stu[trans].Name, stu[trans].Sex, stu[trans].ClassNum, stu[trans].ClassState, stu[trans].ClassType);
